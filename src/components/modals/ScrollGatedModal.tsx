...
function ScrollGatedModal({
  ...
  useEffect(() => {
    ...
    const checkScrollable = () => {
      if (el.scrollHeight <= el.clientHeight + 24 && !hasFiredRef.current) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative flex max-h-[85vh] w-full max-w-2xl animate-[modal-in_0.25s_ease] flex-col rounded-3xl bg-white shadow-2xl">
        ...
        <div
          ...
          className="prose prose-sm prose-gray relative max-w-none flex-1 overflow-y-auto px-7 py-6 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-200 [&::-webkit-scrollbar]:w-1.5"
        >
          {children}
...
export default ScrollGatedModal
